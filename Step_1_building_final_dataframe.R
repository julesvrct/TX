...
#PREAMBULE
#---
#This script allows to build the final dataframe "info_trips" 
#which will be used for classification of the transportation modes
####################################
...
save(info_trips, file = "data/info_trips")
